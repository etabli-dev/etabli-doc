#!/usr/bin/env bash
# capture.sh — screenshot harness for etabli-doc (v0.1.0). Reachable screens only;
# data screens require a running Paperless-ngx instance + credentials.
set -euo pipefail
DBG=com.raban.etabli.doc.debug
